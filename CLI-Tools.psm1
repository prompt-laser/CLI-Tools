function Top {
	...
	While($true){
		...
		cls
		Write-Host "up" $uptime.days "days," [String]$uptime.hours.PadLeft(2,"0") ":" [String]$uptime.minutes.PadLeft(2,"0") ", " $userCount " users, load:" ([string]($totalTime / 100)).substring(0,4)
